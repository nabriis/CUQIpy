"""JAX backend implementation for CUQIpy array operations."""

import warnings
import numpy as np

def load_backend():
    """Load JAX backend and return the module."""
    try:
...
def get_backend_functions(backend_module):
    """Get JAX-specific function implementations."""
    
    # JAX numpy has very similar API to NumPy
    functions = {
