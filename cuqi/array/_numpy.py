...
def load_backend():
    """Load NumPy backend and return the module."""
    return np

def get_backend_functions(backend_module):
    """Get NumPy-specific function implementations."""
    ...
    functions = {
        ...
        # Type hierarchies
        'integer': backend_module.integer,
        'floating': backend_module.floating,
        'complexfloating': backend_module.complexfloating,
    }
    ...
    class PolynomialModule:
        class legendre:
            @staticmethod
            def leggauss(deg):
                return backend_module.polynomial.legendre.leggauss(deg)
...
def pad(array, pad_width, mode='constant', **kwargs):
    """Pad array with proper mode handling."""
